...
const Experience = () => {
  return (
    <div
      ...
      className="bg-[#fed29c] bg-contain lg:bg-right  bg-no-repeat h-[800px] md:h-[1000px] lg:h-[316px] xl:h-[616px] px-4 lg:px-0"
    >
      <div className="max-w-[1321px] mx-auto flex items-end lg:items-center h-full pb-12 md:pb-8 lg:pb-0">
        <div className="w-[500px] md:mx-auto lg:mx-0">
